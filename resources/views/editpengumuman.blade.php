...
<div class="content">
    <br>
    <form method='POST' action='/pengumuman/edit' id='formPengumuman' enctype="multipart/form-data">
        @csrf
            <div class="mb-3">
                <label for="nama" class="form-label">Judul</label>
                <input type="hidden" name="idPengumuman" value="{{ $data['idPengumuman'] }}">
            ...
            <div class="mb-3">
                ...
                <br>
                <textarea rows="4" cols="100%" name="isi" form="formPengumuman" required>{{ $data['isi'] }}</textarea>
            </div>
            <div class="mb-3">
